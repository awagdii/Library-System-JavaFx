...
public class ApplicationInitialDB {
    ...
    public static void prepareSomeInitialData() {
        ...
        superAdministrator1.setFirstName("Anglo");
        superAdministrator1.setLastName("Andro");
        superAdministrator1.setPhoneNumber("+1(641)-76630932");
        Address address = new Address();
        address.setCity("Iowa");
        address.setState("Chicago");
        address.setZip("52557");
        address.setStreet("1000Nth 4th Street");
        superAdministrator1.setAddress(address);


        //Add Administrator One
        SuperAdministrator superAdministrator2 = new SuperAdministrator();
        superAdministrator2.setFirstName("Kefin");
        superAdministrator2.setLastName("Mark");
        superAdministrator2.setPhoneNumber("+1(641)-76600932");
        Address address1 = new Address();
        address1.setCity("Newyork");
        address1.setState("Taxes");
        address1.setZip("129837");
        address1.setStreet("10Nth 8th Street");
        superAdministrator2.setAddress(address);


        ArrayList<SuperAdministrator> admins = new ArrayList<>();
        Collections.addAll(admins, superAdministrator1, superAdministrator2);
        ...
        libM2.setUsername("libmember");
        libM2.setPassword("libmember");
