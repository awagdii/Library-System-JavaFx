...
public class ApplicationInitialDB {
	...
	private ArrayList<LibraryMember> librarians = new ArrayList<>();
	private ArrayList<Administrator> administrators = new ArrayList<>();
	private ArrayList<Book> books = new ArrayList<>();

	public ArrayList<LibraryMember> getLibrarians() {
		return librarians;
	}

	public void setLibrarians(ArrayList<LibraryMember> librarians) {
	...
	public static ApplicationInitialDB loadIntialDB() {
